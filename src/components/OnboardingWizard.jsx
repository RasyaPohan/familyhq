  ...
  if (showGuidePrompt) {
    return (
      <>
        ...
        <div className="fixed left-0 right-0 z-[210] md:left-1/2 md:-translate-x-1/2 md:w-[420px] md:bottom-8" style={{ bottom: "calc(4rem + env(safe-area-inset-bottom, 0px) + 16px)" }}>
    ...
    <>
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="fixed left-0 right-0 z-[150] md:left-1/2 md:-translate-x-1/2 md:w-[480px] md:bottom-6"
